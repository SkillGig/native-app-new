...
const questions = [
  {
    ...
    options: ['Improve labeling', 'Add more buttons', 'Ignore the issue', 'Remove navigation'],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: ['Debugging', 'Typography', 'Comparing designs', 'Exporting files'],
  },
  // Add more questions...
];
...
const QuizQuestions = (props) => {
  ...
  const handleOptionSelect = (optionIndex) => {
    setAnswers((prev) => {
      const updated = [...prev];
      updated[currentQuestion] = { questionIndex: currentQuestion, selectedIndex: optionIndex };
      return updated;
    });
  };
    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{ marginTop: normalizeHeight(34) }}>
          <Text style={[fstyles.mediumTen, { color: 'rgba(255, 255, 255, 0.60)' }]}>
            UI/UX Fundamentals
          </Text>
        ...
        <View style={{ marginTop: normalizeHeight(64) }}>
          {question.options.map((each, index) => {
            ...
            return (
              ...
              >
                <LinearGradient
                  colors={['rgba(62, 45, 94, 0.30)', 'rgba(129, 95, 196, 0.30)']}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 0 }}
                  style={{
                    borderRadius: 40,
        ...
        >
          {currentQuestion > 0 ? (
            <TouchableOpacity onPress={handlePrevious}
              style={{
                backgroundColor: "#2F224B", paddingVertical: normalizeHeight(8),
                paddingHorizontal: normalizeWidth(12), borderRadius: 12, flexDirection: "row", alignItems: "center"
              }}>
              <Image
                source={images.BACKICON}
                style={{
              ...
              /><Text style={[fstyles.semiFourteen, { color: '#C4ADD8' }]}>Previous</Text>
            </TouchableOpacity>
          ) : <View />}
          {currentQuestion < questions.length - 1 ? (
            <TouchableOpacity onPress={handleNext}
              style={{
                backgroundColor: "#815FC4", paddingVertical: normalizeHeight(8),
                paddingHorizontal: normalizeWidth(12), borderRadius: 12, flexDirection: "row", alignItems: "center"
              }}>
        ...
        >
          <View style={{ backgroundColor: "#1C0743", flex: 1, height: '100%', paddingTop: normalizeHeight(32), alignItems: "center" }}>

            <Text style={[fstyles.heavyTwenty, { textAlign: "center", lineHeight: normalizeHeight(24) }]}>Are you sure you want to leave{'\n'}
              the quiz?</Text>
            <View style={{ width: normalizeWidth(328), alignItems: "center", marginTop: normalizeHeight(24) }}>
              <Text style={[fstyles.semiFourteen, { color: 'rgba(238, 231, 249, 0.60)', textAlign: 'center' }]}>If you leave the quiz now, You’ll lose your progress and what you scored till now.</Text>
            </View>

            <TouchableOpacity style={{ backgroundColor: "#815FC4", marginTop: normalizeHeight(52), width: normalizeWidth(308), height: normalizeHeight(42), alignItems: "center", justifyContent: "center", borderRadius: 12 }}>
              <Text style={fstyles.extraBoldFourteen}>Stay in Quiz</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ marginVertical: normalizeHeight(12), width: normalizeWidth(308), height: normalizeHeight(42), alignItems: "center", justifyContent: "center" }}>
              <Text style={[fstyles.extraBoldFourteen, { color: '#815FC4' }]}>Leave Anyway</Text>
            </TouchableOpacity>
          </View>
        </Bottomsheet>
      </PageLayout>
